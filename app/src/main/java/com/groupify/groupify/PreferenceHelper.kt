...
class PreferenceHelper {
    ...
    companion object {
        ...
        fun getUserId(context: Context) = getDefaultPreferences(context).getString(context.getString(R.string.spotify_token_pref), "")
        fun getAuthToken(context: Context) = String.format("Bearer %s", getUserId(context))
